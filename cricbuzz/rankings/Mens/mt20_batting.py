...
def mt20_batting():
    source = requests.get('https://www.icc-cricket.com/rankings/mens/player-rankings/t20i/battin').text
...
if __name__ == '__main__':
    while True:
        mt20_batting()
        wait_time = 1
        print(f'\nWaiting {wait_time} minute before fetching Mens T20 Batting Rankings again...\n')
